...
///     EX: this is used multiple times in the row fall function to allow for a animation to play out before the row
///     actually falls.
/// </summary>
public class TimerUtil
{
    ...
    public static TimerUtil Instance
    {
        get
        {
            ...
            if (result == null) result = _instance ??= new TimerUtil();
