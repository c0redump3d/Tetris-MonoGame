...
public class Slider : UiControl
{
    ...
    public override void Draw(SpriteBatch spriteBatch)
    {
        ...
        spriteBatch.DrawCenteredString(Fonts.Hoog12, $"{Text}:{(int) (sliderValue * Multiplier)}",
            new Vector2(SliderRec.Center.X, SliderRec.Center.Y), Color.White * opacity);
        spriteBatch.DrawBorderedRect(new Rectangle((int) Position.X + (int) (sliderValue * (Size.X - sliderWidth)),
            (int) Position.Y,
