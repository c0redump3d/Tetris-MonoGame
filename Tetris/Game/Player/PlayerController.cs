...
namespace Tetris.Game.Player
{
    public class PlayerController
    {
        ...
        /// </summary>
        public double GetGravityTime() => gravityInterval;
        ...
        public void EndGame(GameTime gameTime)
        {
            ...
            BoardShakeAnimator.Instance.ShakeStart = gameTime.ElapsedGameTime.Milliseconds;
        ...
        public bool IsColliding()
        {
            ...
            if (PlayerBlocks[0].Y == Globals.MaxY || PlayerBlocks[1].Y == Globals.MaxY || PlayerBlocks[2].Y == Globals.MaxY ||
        ...
        public void SetGravity(int level)
        {
            ...
            DebugConsole.Instance.AddMessage($"Set gravity to {gravityInterval}ms");
        }
        ...
        public void Reset()
        {
            DebugConsole.Instance.AddMessage("Game Started");
            gameBoard.Reset();
        ...
        public void DrawPlayer(SpriteBatch spriteBatch)
        {
            ...
            {
                spriteBatch.DrawCenteredString(Globals.Hoog36, @"PAUSED", new Vector2(160, 320), Color.White);
            }
        ...
        public static PlayerController Instance
        {
            get
            {
                ...
                if (result == null)
                {
                    result = _instance ??= new PlayerController();
                }
