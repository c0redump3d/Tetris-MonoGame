...
/// <summary>
///     Creates a clone player that has insanely fast gravity time to show where the block would fall to in its current
///     position.
///     Fun fact:
///     This was previously not able to be done in WinForms since the application could not update its position fast
///     enough.
/// </summary>
public class Prediction
{
    ...
    public static Prediction Instance
    {
        get
        {
            ...
            if (result == null) result = _instance ??= new Prediction();
