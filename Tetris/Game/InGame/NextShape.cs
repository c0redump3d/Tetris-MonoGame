...
public class NextShape
{
    ...
    public static NextShape Instance
    {
        get
        {
            ...
            if (result == null) result = _instance ??= new NextShape();
    ...
    public void GenerateNextShape()
    {
        if (whereAt == 7)
        {
            ...
            Gui.Instance.AddDebugMessage(
                $"Next Bag: {shapeList[0]},{shapeList[1]},{shapeList[2]},{shapeList[3]},{shapeList[4]}");
        }
        ...
        if (whereAt == 14)
        {
            nextShapeList.Shuffle();
            Gui.Instance.AddDebugMessage(
                $"Next Bag: {nextShapeList[0]},{nextShapeList[1]},{nextShapeList[2]},{nextShapeList[3]},{nextShapeList[4]}");
            whereAt = 0;
        }
