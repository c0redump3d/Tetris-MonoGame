...
public class Packet
{
    ...
    /// <summary>
    ///     Packet ID is the value used to find a specific packet in game, for example ID 2 is BoardPacket
    /// </summary>
    protected int PacketID { get; }
    ...
    /// <summary>
    ///     Allows a packet to be sent to the client/server by giving its packetName value. This can also include data if
    ///     provided (see parameter data).
    /// </summary>
